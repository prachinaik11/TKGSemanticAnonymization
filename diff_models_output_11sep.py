...
def compare_diff_models(files, file_labels):
    ...
    # Plot the data with log scale for the Y-axis
    ...
    plt.ylabel('AIL Values (Log Scale)')
    plt.title('Comparison of AIL Values Across Files (Log Scale)')
    ...
    output_file = 'comparison_diff_models_log.png'
