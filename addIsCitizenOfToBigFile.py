...
#
# for file in files:
#     input_file = f'snapshots/snapshots_yago_big_dataset/{file}'
#     output_file = f'snapshots/snapshots_yago_big_dataset/outputs/output_final_{file}.csv'
#     process_triples(input_file, output_file)
# file = "snapshot_2003_2017_1.tsv"
# file = "snapshot_2003_2017 (copy).tsv"
input_file = f'dataset/myYagoDataset (another copy).csv'
output_file = f'dataset/output_final.csv'
process_triples(input_file, output_file)