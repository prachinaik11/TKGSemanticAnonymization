...
def process_csv(input_file, output_file):
    ...
    with open(output_file, 'w') as f:
        ...
        for subject, group_data in gk:
            ...
            sen_attr = group_data['country'].iloc[0]
...
if __name__ == "__main__":
    ...
    directory_path = anony_path + 'Freebase/snapshots/outputs'
    ...
    #          'snapshot_2003_2017']
    for file in files:
        input_file = f'{anony_path}Freebase/snapshots/outputs/{file}'
        output_file = f'{anony_path}Freebase/snapshots/Final_snapshots_containing_sentences/final_{file}'
